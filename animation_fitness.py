...
fileName = 'Ex 0.01 Ba 0.2 Go 0.1 Co 0.1 Sp 200 test 2'
...
freshLattice = np.random.randint(0, 30, (L, L))  # the lattice randomly selected
...
while i < seconds*fps - 1 and extinct == False:
    simulation3.simulation_one_generation(lattice, selectionRate, reproductionRate, colonisationRate, exchangeRate, baseRate, cost, good_per_cooperater)
